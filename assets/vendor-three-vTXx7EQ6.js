...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function gc(i,e,t){const n=new Float32Array(gn),r=new I(0,1,0);return new Vt({name:"SphericalGaussianBlur",defines:{n:gn,CUBEUV_TEXEL_WIDTH:1/e,CUBEUV_TEXEL_HEIGHT:1/t,CUBEUV_MAX_MIP:`${i}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:n},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:r}},vertexShader:Ci(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Zr(){return new Vt({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Ci(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function $r(){return new Vt({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Ci(),fragmentShader:`
...
#define LOW_PRECISION`),e}const Fu={1:"SHADOWMAP_TYPE_PCF",3:"SHADOWMAP_TYPE_VSM"};function Uu(i){return Fu[i.shadowMapType]||"SHADOWMAP_TYPE_BASIC"}const Iu={301:"ENVMAP_TYPE_CUBE",302:"ENVMAP_TYPE_CUBE",306:"ENVMAP_TYPE_CUBE_UV"};function Nu(i){return i.envMap===!1?"ENVMAP_TYPE_CUBE":Iu[i.envMapMode]||"ENVMAP_TYPE_CUBE"}const Ou={302:"ENVMAP_MODE_REFRACTION"};function Bu(i){return i.envMap===!1?"ENVMAP_MODE_REFLECTION":Ou[i.envMapMode]||"ENVMAP_MODE_REFLECTION"}const Gu={0:"ENVMAP_BLENDING_MULTIPLY",1:"ENVMAP_BLENDING_MIX",2:"ENVMAP_BLENDING_ADD"};function zu(i){return i.envMap===!1?"ENVMAP_BLENDING_NONE":Gu[i.combine]||"ENVMAP_BLENDING_NONE"}function Vu(i){const e=i.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,n=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),7*16)),texelHeight:n,maxMip:t}}function Hu(i,e,t,n){const r=i.getContext(),s=t.defines;let a=t.vertexShader,o=t.fragmentShader;const c=Uu(t),l=Nu(t),h=Bu(t),f=zu(t),d=Vu(t),_=Au(t),x=bu(s),S=r.createProgram();let m,u,A=t.glslVersion?"#version "+t.glslVersion+`
